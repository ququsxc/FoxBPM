...
/**
 * 获取svg资源，只展示当前用户经办的部分
 * 
 * @author yuanbing
 * @date 2016年11月21日
 */
public class FlowGraphicSvgForMeResource extends AbstractRestResource {
	@Get
	public DataResult getFlowGraphicImg() {
		...
		String svgContent = modelService.getProcessDefinitionSVGForMe(processDefinitionId, processInstanceId);
